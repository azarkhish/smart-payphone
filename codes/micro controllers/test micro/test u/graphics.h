...
ret
;----------------------------------
show_handset_det_test:
mov dptr,# handset_det            
    mov TEXTURE_LENGTH,#64               ;tool
    mov START_ROW,#ROW_7               ;lcd code  4
    mov START_COL,#040h               ;lcd code  0
    mov b,STATUS_FLAGS
